...
class qmkl6_context {
    ...
    public:
        ...
        uint32_t unif_handle, qpu_sasum_handle, qpu_saxpy_handle,
                qpu_scopy_handle, qpu_sdot_handle, qpu_snrm2_handle,
                qpu_sscal_handle, qpu_sgemv_n_handle, qpu_sgemv_t_handle,
                qpu_sgemm_rnn_handle, qpu_sgemm_rnt_handle,
                qpu_sgemm_rtn_handle, qpu_sgemm_rtt_handle;
        uint32_t unif_bus, qpu_sasum_bus, qpu_saxpy_bus, qpu_scopy_bus,
                qpu_sdot_bus, qpu_snrm2_bus, qpu_sscal_bus, qpu_sgemv_n_bus,
                qpu_sgemv_t_bus, qpu_sgemm_rnn_bus, qpu_sgemm_rnt_bus,
                qpu_sgemm_rtn_bus, qpu_sgemm_rtt_bus;
        uint32_t *unif;
        uint64_t *qpu_saxpy, *qpu_sasum, *qpu_scopy, *qpu_sdot, *qpu_snrm2,
                *qpu_sscal, *qpu_sgemv_n, *qpu_sgemv_t, *qpu_sgemm_rnn,
