...
@qpu
def qpu_snrm2(asm, *, num_qpus, unroll_shift, code_offset,
    ...
    with loop as l:
        ...
        for j in range(unroll - 1):
            for i in range(8):
                mov(tmua, reg_x).fmul(r0, r0, r0)
                fadd(r3, r3, r0, sig=ldtmu(r0)).add(reg_x, reg_x, reg_x_inc)

        for i in range(6):
            fmul(r0, r0, r0)
            fadd(r3, r3, r0, sig=ldtmu(r0))

        fmul(r0, r0, r0)

        l.b(cond='na0')
        fadd(r3, r3, r0, sig=ldtmu(r0))  # delay slot
        fmul(r0, r0, r0)                 # delay slot
        fadd(r3, r3, r0)                 # delay slot
...
def main():
    ...
    for insn in assemble(qpu_snrm2, num_qpus=num_qpus,
