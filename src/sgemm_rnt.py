...
@qpu
def qpu_sgemm_rnt(asm, *, num_qpus, code_offset, align_cond=lambda pos: True):
    ...
    sub(null, r2, IDX0_A, cond='pushz').umul24(r3, r5, r1)
    ...
    with loop as lm:
        ...
        with loop as ln:
            ...
            with loop as lk:
                ...
                # Load *(A_CUR + 4 * LDA * num_qpus * eidx)
...
def main():
    ...
    for insn in assemble(qpu_sgemm_rnt, num_qpus=num_qpus,
